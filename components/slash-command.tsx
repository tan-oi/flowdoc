      ...
      <SlashCmd.Cmd>
        <SlashCmd.Empty>
          <SlashCmd.Item
            ...
            onCommand={(val) => {
              suggestionItems[0].command(val);
            }}
          >
            {suggestionItems[0].title}
          </SlashCmd.Item>
        </SlashCmd.Empty>
        <SlashCmd.List className="bg-neutral-900 px-4 rounded-lg min-w-[130px] max-h-64 overflow-y-auto overscroll-contain scrollbar-none py-2">
