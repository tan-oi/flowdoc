...
export const useHistoryState = create<DocumentStore>((set, get) => ({
  ...
  addBatchedEntry: (docId, entry) => set((state) => ({
    batchedEntries: {
      ...state.batchedEntries,
      [docId]: [
  ...
  clearInactiveDocuments: () => set((state) => {
  ...
  markEntriesAsSaved: (docId, entryIds) => set((state) => ({
    batchedEntries: {
      ...state.batchedEntries,
  ...
  clearBatchedEntries : (docId : string) => set((state) => ({
    batchedEntries : {
      ...state.batchedEntries,
      [docId] : []
    }
